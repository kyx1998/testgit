...
<div class="row">
    <div class="col-sm-3">
        <h4>添加展示图</h4>
        <form action="?r=showimg/add" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label>书名</label>
                <input type="text" name="book_name" class="form-control" placeholder="" onblur="check();">
                                ...
                                <div class="row">
                                    <ul class="ace-thumbnails" id="list_image_src" >
                                        <li><a href="" title="Photo Title" data-rel="colorbox"><img src="" name="img" id="img"></a><div class="tools">
                                            ...
                                            </div><input type="text" value="" name="show_img" hidden></li>   <!--存储img图片路径-->
