...
<div class="contain">
    ...
    <div class="main2">
        ...
        <div class="qzdjb">
            ...
            <div class="new_book_link" id="list1">
                <ul>
                    <?php for($i=0;$i<count($person_click);$i++):?>
                        <li><label style="color: white;font-size: 12px" class="num"><?= $i+1?></label><a href="?r=detail/detail&book_id=<?= $person_click[$i]['book_id']?>"><?= $person_click[$i]['book_name']?></a><span class="user_name"><?= $person_click[$i]['user_name']?></span></li>
                    <?php endfor;?>
                </ul>
            </div>
            <div id="list2" style="display: none" class="new_book_link">
        ...
        <div class="qzscb">
            ...
            <div class="new_book_link" id="list1">
                <ul>
                    <?php for($i=0;$i<count($person_save);$i++):?>
                        <li><label style="color: white;font-size: 12px" class="num"><?= $i+1?></label><a href="?r=detail/detail&book_id=<?= $person_save[$i]['book_id']?>"><?= $person_save[$i]['book_name']?></a><span class="user_name"><?= $person_save[$i]['user_name']?></span></li>
                    <?php endfor;?>
                </ul>
            </div>
            <div id="list2" style="display: none" class="new_book_link">
    ...
    <div class="main3">
        <div class="boy_list">
            <div class="list_head">
                <h3>排行榜</h3>
                <a href="javascript:void(0);" onclick="list_switch('new');">新书</a>
                |
                <a href="javascript:void(0);" onclick="list_switch('serial');">连载</a>
                |
                <a href="javascript:void(0);" onclick="list_switch('com');">完本</a>
            </div>
            <div class="list new">
                <?php for($i=0;$i<ceil(count($person_new)/4);$i++):?>
                    <?php if($i==ceil(count($person_new)/4)-1){?>
                        <ul>
                            <?php for($j=$i*4;$j<count($person_new);$j++):?>
                                <li><label style="color: white;font-size: 12px" class="num"><?= $j+1?></label><a href="#"><?= $person_new[$j]['book_name']?></a><span class="user_name"><?= date('Y-m-d H:i:s',$person_new[$j]['ctime'])?></span></li>
                            <?php endfor;?>
                        </ul>
                    <?php }else{?>
                        <ul>
            ...
            <div style="display: none" class="list serial">
                <?php for($i=0;$i<ceil(count($person_serial)/4);$i++):?>
                    <?php if($i==ceil(count($person_serial)/4)-1){?>
                        <ul>
                            <?php for($j=$i*4;$j<count($person_serial);$j++):?>
                                <li><label style="color: white;font-size: 12px" class="num"><?= $j+1?></label><a href="#"><?= $person_serial[$j]['book_name']?></a><span class="user_name"><?= date('Y-m-d H:i:s',$person_serial[$j]['ctime'])?></span></li>
                            <?php endfor;?>
                        </ul>
                    <?php }else{?>
                        <ul>
            ...
            <div style="display: none" class="list com">
                <?php for($i=0;$i<ceil(count($person_com)/4);$i++):?>
                    <?php if($i==ceil(count($person_com)/4)-1){?>
                        <ul>
                            <?php for($j=$i*4;$j<count($person_com);$j++):?>
                                <li><label style="color: white;font-size: 12px" class="num"><?= $j+1?></label><a href="#"><?= $person_com[$j]['book_name']?></a><span class="user_name"><?= date('Y-m-d H:i:s',$person_com[$j]['ctime'])?></span></li>
                            <?php endfor;?>
                        </ul>
                    <?php }else{?>
                        <ul>
