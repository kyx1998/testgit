...
<div class="contain">
    ...
    <div class="main2">
        ...
        <div class="qzdjb">
            ...
            <div class="new_book_link" id="list1">
                <ul>
                    <?php for($i=0;$i<count($boy_click);$i++):?>
                        <li><label style="color: white;font-size: 12px" class="num"><?= $i+1?></label><a href="?r=detail/detail&book_id=<?= $boy_click[$i]['book_id']?>"><?= $boy_click[$i]['book_name']?></a><span class="user_name"><?= $boy_click[$i]['user_name']?></span></li>
                    <?php endfor;?>
                </ul>
            </div>
            <div id="list2" style="display: none" class="new_book_link">
        ...
        <div class="qzscb">
            ...
            <div class="new_book_link" id="list1">
                <ul>
                    <?php for($i=0;$i<count($boy_save);$i++):?>
                        <li><label style="color: white;font-size: 12px" class="num"><?= $i+1?></label><a href="?r=detail/detail&book_id=<?= $boy_save[$i]['book_id']?>"><?= $boy_save[$i]['book_name']?></a><span class="user_name"><?= $boy_save[$i]['user_name']?></span></li>
                    <?php endfor;?>
                </ul>
            </div>
            <div id="list2" style="display: none" class="new_book_link">
    ...
    <div class="main3">
        <div class="boy_list">
            ...
            <div class="list new">
                <?php for($i=0;$i<ceil(count($boy_new)/4);$i++):?>
                    <?php if($i==ceil(count($boy_new)/4)-1){?>
                <ul>
                    <?php for($j=$i*4;$j<count($boy_new);$j++):?>
                        <li><label style="color: white;font-size: 12px" class="num"><?= $j+1?></label><a href="#"><?= $boy_new[$j]['book_name']?></a><span class="user_name"><?= date('Y-m-d H:i:s',$boy_new[$j]['ctime'])?></span></li>
                    <?php endfor;?>
                </ul>
                <?php }else{?>
                <ul>
            ...
            <div style="display: none" class="list serial">
                <?php for($i=0;$i<ceil(count($boy_serial)/4);$i++):?>
                    <?php if($i==ceil(count($boy_serial)/4)-1){?>
                        <ul>
                            <?php for($j=$i*4;$j<count($boy_serial);$j++):?>
                                <li><label style="color: white;font-size: 12px" class="num"><?= $j+1?></label><a href="#"><?= $boy_serial[$j]['book_name']?></a><span class="user_name"><?= date('Y-m-d H:i:s',$boy_serial[$j]['ctime'])?></span></li>
                            <?php endfor;?>
                        </ul>
                    <?php }else{?>
                        <ul>
            ...
            <div style="display: none" class="list com">
                <?php for($i=0;$i<ceil(count($boy_com)/4);$i++):?>
                    <?php if($i==ceil(count($boy_com)/4)-1){?>
                        <ul>
                            <?php for($j=$i*4;$j<count($boy_com);$j++):?>
                                <li><label style="color: white;font-size: 12px" class="num"><?= $j+1?></label><a href="#"><?= $boy_com[$j]['book_name']?></a><span class="user_name"><?= date('Y-m-d H:i:s',$boy_com[$j]['ctime'])?></span></li>
                            <?php endfor;?>
                        </ul>
                    <?php }else{?>
                        <ul>
