    ...
    <div class="main-container-inner">
                    ...
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" role="form" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input id="x" type="text"  name="dress_name" class="input-small" />
                                </div>
                            </div>
                                                ...
                                                <div class="row">
                                                    <ul class="ace-thumbnails" id="list_image_src" >
                                                        <li><a href="" title="Photo Title" data-rel="colorbox"><img src="" name="img" id="img"></a><div class="tools">
                                                            ...
                                                            </div><input type="text" value="" name="dress_img" hidden></li>   <!--存储img图片路径-->
        ...
        <script>
            ...
            function Submit(){
                ...
                ajaxUpFile('?c=Dress&m=addDress',formData,function(respTest){
