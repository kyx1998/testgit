    ...
    <div class="main-container-inner">
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <caption><button class="btn btn-primary btn-xs" onclick="javascript:history.back();"><span class="glyphicon glyphicon-arrow-left"></span> 后退</button></caption>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="table-responsive">
                            <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                <?php foreach ($replyInfos as $info):?>
                                    <tr>
                                        <td><?php echo $msgInfo['title']; ?></td>
                                        <td><?php echo $info['msg_id']; ?></td>
                                        <td><?php echo $info['reply_id']; ?></td>
                                        <td><?php echo $info['reply_content']; ?></td>
                                        <td><?php echo $info['ctime']; ?></td>
                                        <td>
                                            <a class="red" href="" onclick="DeleteInfo(<?php echo $info['reply_id'];?>);">
        ...
        <script>
            ...
            function DeleteInfo(reply_id){
                ...
                ajaxUpFile('?c=Msg&m=deleteReply',formData,function(respTest){
