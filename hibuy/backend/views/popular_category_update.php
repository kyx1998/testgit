    ...
    <div class="main-container-inner">
                    ...
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" role="form" enctype="multipart/form-data">
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="x"> 类别名 </label>
                                <div class="col-sm-7">
                                    <input type="text" name="popular_category_id" value="<?php echo $PopularCategoryInfo['popular_category_id'];?>" hidden>
                                    <input id="x" type="text"  name="popular_category_name" class="input-small" value="<?php echo $PopularCategoryInfo['popular_category_name'];?>"/>
                                </div>
                            </div>
                                            ...
                                            <div class="widget-main">
                                                <div class="row">
                                                    <ul class="ace-thumbnails" id="list_image_src" >
                                                        <li><a href="<?php echo $PopularCategoryInfo['popular_category_img']?>" title="Photo Title" data-rel="colorbox"><img src="<?php echo $PopularCategoryInfo['popular_category_img']?>" name="img" id="img"></a><div class="tools">
                                                                <a href="javascript:void(0);" onclick="DeleteImage(this);">
                                                                    <i class="icon-remove red"></i>
                                                                </a>
                                                            </div><input type="text" value="<?php echo $PopularCategoryInfo['popular_category_img']?>" name="popular_category_img" hidden></li>   <!--存储img图片路径-->
        ...
        <script>
            ...
            function Submit(){
                ...
                ajaxUpFile('?c=PopularCategory&m=updatePopularCategoryPage',formData,function(respTest){
                    ...
                    alert('添加成功');
                    document.getElementsByName('popular_category_name')[0].value = xmlHttpObj.data.popular_category_name;
                    document.getElementsByName('popular_category_img')[0].value = xmlHttpObj.data.popular_category_img;
                })
            }
        </script>
</body>
