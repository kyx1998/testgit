                    ...
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" role="form" enctype="multipart/form-data">
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="x"> 标题名 </label>
                                <div class="col-sm-7">
                                    <input id="x" type="text"  name="title" class="input-small" />
                                </div>
                            </div>
                                                ...
                                                <div class="row">
                                                    <ul class="ace-thumbnails" id="list_image_src" >
                                                        <li><a href="" title="Photo Title" data-rel="colorbox"><img src="" name="img" id="img"></a><div class="tools">
                                                            ...
                                                            </div><input type="text" value="" name="msg_img" hidden></li>   <!--存储img图片路径-->
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="x"> 内容 </label>
                                <div class="col-sm-7">
                                    <textarea rows="15" cols="70" name="msg_content"></textarea>
                                </div>
                            </div>
        ...
        <script>
            ...
            function UpFile(elem,url){
                ...
                ajaxUpFile(url, formData, function (respTest) {
                    ...
                    document.getElementsByName('msg_img')[0].value = img_url;
                });
            }
            function Submit(){
                var submit = document.getElementsByName('submit')[0].value;
                var title = document.getElementsByName('title')[0].value;
                var msg_img = document.getElementsByName('msg_img')[0].value;
                var msg_content = document.getElementsByName('msg_content')[0].value;
                ...
                formData.append('popular_category_name',title);
                formData.append('popular_category_img',msg_img);
                formData.append('msg_content',msg_content);
                ajaxUpFile('?c=Msg&m=addMsg',formData,function(respTest){
